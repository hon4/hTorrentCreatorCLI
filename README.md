...
make install
```
Do ***NOT*** clone the main branch, use the (https://github.com/hon4/hTorrentCreatorCLI/releases)[releases]. The main branch has changing code and may not work properly.
